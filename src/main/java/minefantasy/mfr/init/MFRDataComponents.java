...
public class MFRDataComponents {
    ...
    static {
        COMPONENTS = DeferredRegister.DataComponents.createDataComponents(Registries.DATA_COMPONENT_TYPE, MineFantasyReforged.MOD_ID);

        MATERIAL_DATA_COMPONENT_TYPE = COMPONENTS.register("material", () ->
                DataComponentType.<MaterialDataComponent>builder()
                        ...
                        .build());
        CRAFT_QUALITY_DATA_COMPONENT_TYPE = COMPONENTS.register("craft_quality", () ->
                DataComponentType.<CraftQualityDataComponent>builder()
                        ...
                        .build());
        INFERIOR_QUALITY_DATA_COMPONENT_TYPE = COMPONENTS.register("inferior_quality", () ->
                DataComponentType.<InferiorQuailtyDataComponent>builder()
                        ...
                        .build());
        SPECIAL_TYPE_DATA_COMPONENT_TYPE = COMPONENTS.register("special_type", () ->
                DataComponentType.<SpecialTypeDataComponent>builder()
                        ...
                        .build());
        SHARPNESS_DATA_COMPONENT_TYPE = COMPONENTS.register("sharpness", () ->
