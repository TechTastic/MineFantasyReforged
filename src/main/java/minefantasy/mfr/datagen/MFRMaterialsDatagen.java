...
public class MFRMaterialsDatagen extends DatapackBuiltinEntriesProvider {
    public MFRMaterialsDatagen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, Set<String> modIds) {
        super(output, registries, new RegistrySetBuilder()
                .add(CustomMaterialRegistry.MATERIAL_REGISTRY_KEY, MFRMaterialsDatagen::bootstrap), modIds);
    }
